...
var div = dom.create("<div>你好</div>"); //console.log(div);

dom.after(test, div);
var div2 = dom.create("<div id=\"dvi2\"></div>");
dom.wrap(test, div2); //console.log(div2);

var nodes = dom.empty(empty); //console.log(nodes);

dom.attr(test, "title", "hi,i am frank");
var title = dom.attr(test, "title");
console.log("title:".concat(title));
dom.text(test, "这是新的内容");
var text = dom.text(test);
...
var testDiv3 = dom.find("#test3>.red")[0];
